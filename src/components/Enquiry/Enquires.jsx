...
//   console.log("Current enquiries data:", enquiries); // Log the enquiries data
...
//     if (showModel) {
//       fetchEnquiries(); // Fetch enquiries when closing the modal
//     }
//   };
...
//   useEffect(() => {
//     fetchEnquiries(); // Fetch enquiries when the component mounts
//   }, []);
