...
export const AdmissionAction = ({handleAdd, showModel, toggleModel, editUser} ) => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
      ...
      <div className="w-full md:w-auto flex flex-col md:flex-row  md:space-y-0 items-stretch md:items-center justify-end flex-shrink-0">
        ...
        {showModel && (
          <AdmissionForm toggleModel={toggleModel} editDetails={editUser} />
        // <PreviewAdmission togglePrevModel={showModel} data={"ram"}/>
        )}
      </div>
    </div>
  )
