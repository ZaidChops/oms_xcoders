...
const CourseForm = ({ toggleModel, setAllCourses, editCourse }) => {
  ...
  const [courseCategory, setCourseCategory] = useState(editCourse?.courseCategory || "");
  const [courseDuration, setCourseDuration] = useState(editCourse?.courseDuration || "");
  ...
  const handleSubmit = (e) => {
    ...
    if (editCourse) {
      ...
      const existingCourses = JSON.parse(localStorage.getItem("courseData")) || [];
      ...
      const existingCourses = JSON.parse(localStorage.getItem("courseData")) || [];
      localStorage.setItem("courseData", JSON.stringify([...existingCourses, updatedCourse]));
    }
